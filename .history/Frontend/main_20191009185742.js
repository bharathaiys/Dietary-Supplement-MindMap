...
function update(source, slow) {
    ...
    nodeEnter.append("svg:rect")
        ...
        console.log(bbox);
        vx = d3.transform(container.attr("transform")).translate[0];		// container x co-ordinate
        vy = d3.transform(container.attr("transform")).translate[1];		// container y co-ordinate
...
var queryServer = function () {
    let data = {
        query: "Match (a:SDSI)-[b:is_effective_for]-(c:DIS {name:'Colds, Common'}) return a, b, c;"
    };
