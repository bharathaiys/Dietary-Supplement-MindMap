...
export class MindmapComponent implements OnInit {
  ...
  queryServer = function () {
    ...
    if (this.problemId === '1') {
      ...
      data = {
        query: `Match (a:DSP)-[:has_ingredient]-(SDSI)-[b:is_effective_for]-(c:DIS {name:'${this.selectedSympton}'}) return a, b, c limit 10;`
      }
      
    }
    else if (this.problemId === '3') {
      data = {
        query: `Match (a:SDSI)-[b:is_effective_for]-(c:DIS {name:'${this.selectedSympton}'}) return a, b, c limit 10;`
      }
    }
